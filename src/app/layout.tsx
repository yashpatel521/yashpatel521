...
export const metadata: Metadata = {
  ...
  description: "Explore the creative portfolio of Yash Patel, a Full Stack Developer specializing in high-performance web applications, Next.js optimization, modular systems, and interactive experiences.",
  keywords: [
    "Yash Patel",
    "Yash Patel Montreal",
