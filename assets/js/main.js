(function ($) {
  ...
  $(".darkLightMode").on("click", function (e) {
    if ($("body").hasClass("white-version")) {
      $("body").removeClass("white-version");
      $("body").addClass("dark-version");
      $(this).children().replaceWith(feather.icons["sun"].toSvg());
    } else {
      $("body").removeClass("dark-version");
      $("body").addClass("white-version");
      $(this).children().replaceWith(feather.icons["moon"].toSvg());
    }
  });

  $(".rn-portfolio").on("click", function (e) {
    var title = $(this).find(".title").children().text();
    var feature = $(this).find(".category-list").children().text();
    var description = $(this).find(".description").text();
    var projectLink = $(this).find(".projectLink").text();
    var image = $(this).find(".thumbnail").children().children().attr("src");

    $("#exampleModalCenter")
      .find(".title")
      .html(`<span>Featured - ${feature}</span> ${title}.`);
    $("#exampleModalCenter").find(".description").html(description);
    $("#exampleModalCenter").find(".projectLink").attr("href", projectLink);
    $("#exampleModalCenter").find(".image").children().attr("src", image);
  });
})(jQuery, window);
